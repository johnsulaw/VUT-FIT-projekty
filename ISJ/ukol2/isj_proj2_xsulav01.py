...
def she_says_he_says(she_says):
    ...
    phonetic_she_says = she_says.replace('y', 'i', 1)                             # vase reseni
...
def solfege(title_hymn):
    ...
    possible_title, sep, hymn = title_hymn.split(':')[0], title_hymn[title_hymn.find(":")], title_hymn.split(':')[-1]   # vase reseni
