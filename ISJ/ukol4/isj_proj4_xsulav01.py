...
def match_permutations_substrings(string, words):
    ...
    return {i for i in perms if i in words}                                       # your solution
...
def uniq_srt(it):
    ...
    return sorted(my_set)                                     # your solution
...
def uniq_orig_order(it):
    ...
    orig_order = []
    [orig_order.append(i) for i in it if i not in orig_order]

    return orig_order                                     # your solution
